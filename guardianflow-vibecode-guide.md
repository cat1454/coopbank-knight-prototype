# GuardianFlow AI — Vibe-code Guide

> **Dự án:** GuardianFlow AI — Lá chắn giao dịch thông minh cho ngân hàng số  
...
```
Tôi đang xây dựng GuardianFlow AI — hệ thống phát hiện gian lận giao dịch ngân hàng số.
...
```
Tiếp tục dự án GuardianFlow AI.
...
```
Tiếp tục dự án GuardianFlow AI. Đã có types.ts và mockData/.
...
```
Tiếp tục GuardianFlow AI. Đã có 5 agents và orchestrator.
...
```
Tiếp tục GuardianFlow AI. Domain layer đã xong.
...
```
Tiếp tục GuardianFlow AI. Server đang chạy ở localhost:3001.
...
```
Tiếp tục GuardianFlow AI. Viết test coverage cho domain layer và E2E.
...
```
Tiếp tục GuardianFlow AI. Thêm Audit Trail và Consent (theo yêu cầu tuân thủ MVP).
...
- Tiêu đề: "GuardianFlow AI bảo vệ giao dịch của bạn"
- 3 mục giải thích:
...
"GuardianFlow AI chỉ xử lý dữ liệu cần thiết để đánh giá rủi ro giao dịch.
...
```
Tiếp tục GuardianFlow AI. Đây là prompt cuối, polish cho demo pitch.
