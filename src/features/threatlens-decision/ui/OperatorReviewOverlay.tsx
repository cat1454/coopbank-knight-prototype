...
export function OperatorReviewOverlay({ threatLens }: OperatorReviewOverlayProps) {
  if (!threatLens.isHumanReviewing) return null;
...
<div className="operator-call-overlay" style={{
          ...
          <div className="operator-call-card" style={{
            ...
            {threatLens.humanReviewStep === "connecting" && (
            ...
            {threatLens.humanReviewStep === "chatting" && (
              <div className="operator-chatting" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", width: "100%" }}>
                ...
                <div className="operator-actions" style={{ display: "grid", gap: "8px", width: "100%" }}>
                  <button
                    ...
                    onClick={() => threatLens.completeHumanReview(true)}
                  >
                  ...
                  <button
                    ...
                    onClick={() => threatLens.completeHumanReview(false)}
                  >
                    Tôi bị lừa, xin hủy!
                  </button>
                </div>
            ...
            {threatLens.humanReviewStep === "approved" && (
            ...
            {threatLens.humanReviewStep === "rejected" && (
