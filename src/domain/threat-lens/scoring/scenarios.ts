...
import type { ThreatLensScenario, ThreatLensScenarioId } from "../types";
import { isoAt } from "./scoringUtils";

export const threatLensScenarios: ThreatLensScenario[] = [
  {
    id: "low_risk",
    label: "An toàn",
  ...
  },
  {
    ...
    transaction: {
      ...
      recipientName: "Lừa đảo: Mã độc APK",
      recipientAccount: "88884920412",
      recipientBank: "Co-opBank",
  ...
  },
  {
    ...
    transaction: {
      ...
      recipientName: "Lừa đảo: Tuyển CTV giật đơn",
  ...
  },
  {
    ...
    transaction: {
      ...
      recipientName: "Lừa đảo: SMS Phishing tri ân",
      recipientAccount: "77771020412",
  ...
  },
  {
    ...
    transaction: {
      ...
      recipientName: "Lừa đảo: Sàn đầu tư ảo",
...
export function getThreatLensScenario(id: ThreatLensScenarioId) {
  const scenario = threatLensScenarios.find((candidate) => candidate.id === id);

  if (!scenario) {
    throw new Error(`Unknown ThreatLens scenario: ${id}`);
  }
