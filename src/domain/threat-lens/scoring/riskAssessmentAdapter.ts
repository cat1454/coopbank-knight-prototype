...
import type { ThreatLensRiskDecision, ThreatLensScenario, RiskAssessment, RiskSignal } from "../types";
...
function signalFromReason(code: string): RiskSignal {
  ...
  return {
    ...
    auditText: `ThreatLens reason: ${code}`,
  };
}

export function adaptThreatLensDecisionToRiskAssessment(
